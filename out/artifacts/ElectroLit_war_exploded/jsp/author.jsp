        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <ul class="list-group list-group-horizontal">
                    <li onclick="window.location='/addAuthor'" class="list-group-item"><a href="#">Добавить запись</a></li>
                    <li onclick="updateAuthor()" class="list-group-item"><a href="#">Изменить запись</a></li>
                    <li onclick="deleteAuthor()" class="list-group-item"><a href="#">Удалить запись</a></li>
                </ul>
