...
<h3 align="center">Книга-Автор</h3>
<ul class="menu-main">
    <li onclick="window.location='/addBookAuthor'"><a href="#">Добавить запись</a></li>
    <li onclick="updateBookAuthor()"><a href="#">Изменить запись</a></li>
    <li onclick="deleteBookAuthor()"><a href="#">Удалить запись</a></li>
    <li>Сортировка</li>
</ul>
<table id="tables">
    <tr>
