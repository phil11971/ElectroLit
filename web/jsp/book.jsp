...
<h3 align="center">Книга</h3>
<ul class="menu-main">
    <li onclick="window.location='/addBook'"><a href="#">Добавить запись</a></li>
    <li onclick="updateBook()"><a href="#">Изменить запись</a></li>
    <li onclick="deleteBook()"><a href="#">Удалить запись</a></li>
    <li>Сортировка</li>
</ul>
<table id="tables">
    <tr>
